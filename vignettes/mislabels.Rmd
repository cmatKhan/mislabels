...
In thinking about this further, I realized that there is also no reason to 
exclude secondary alignments which align as well as the primary alignment, since 
we aren't interested in the actual count. So, I also performed the pileup using 
...
Number of uncertains in each of the three data sets

How many genome snp vectors are exactly the same. Histogram of differences

Same thing for pileups

conduct experiment, show table
